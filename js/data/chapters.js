const CHAPTERS=[
{id:'ch1',num:'01',title:'L\'OPJ & le Procès Pénal',sub:'Missions · Compétences · Contrôle',color:'#4d8fff',bg:'rgba(77,143,255,.12)',icon:'âš–ï¸',
lessons:[
  {id:'L101',em:'âš–ï¸',name:'Le Procès Pénal',ref:'Art. 1 CPP',xp:10,
    ...
    secs:[
      ...
      {t:'La tripartition des infractions',items:['<b class="art">Crime</b> → Réclusion criminelle / perpétuité → <b>Cour d\'assises</b>','<b class="art">Délit</b> → Emprisonnement + amende → <b>Tribunal correctionnel</b>','<b class="art">Contravention</b> → Amende ≤ 1 500 â‚¬ → <b>Tribunal de police</b>']},
    ],
  ...
  {id:'L103',em:'ðŸ›ï¸',name:'Organisation judiciaire',ref:'Art. 12-13 CPP',xp:10,
    intro:'L\'OPJ agit sous la direction du Procureur et le contrôle de la Chambre de l\'instruction. Cette double supervision est un pilier de l\'Ã‰tat de droit.',
    secs:[
...
{id:'ch2',num:'02',title:'Les Cadres d\'Enquête',sub:'Flagrance · Préliminaire · CR · Art. 74',color:'#ef4444',bg:'rgba(239,68,68,.1)',icon:'ðŸš¨',
lessons:[
  {id:'L201',em:'ðŸš¨',name:'L\'Enquête de Flagrance',ref:'Art. 53 CPP',xp:15,
    ...
    traps:['8 jours = durée ENQUÃŠTE (pas la GAV !). GAV = 24h+24h = 48h max.','La flagrance autorise les perquisitions de nuit (pas de limite horaire)'],
    keys:['Art. 53 al.1 : 4 hypothèses de flagrance','Enquête : 8j (+8j JLD). GAV : 48h (+48h CO) = indépendant']},
  {id:'L202',em:'ðŸ”',name:'L\'Enquête Préliminaire',ref:'Art. 75 CPP',xp:15,
...
{id:'ch3',num:'03',title:'La Garde à Vue',sub:'Tous régimes · Droits · Prolongations',color:'#D4AF37',bg:'rgba(212,175,55,.12)',icon:'ðŸ”’',
lessons:[
  {id:'L301',em:'ðŸ”’',name:'GAV Droit Commun',ref:'Art. 62-2, 63 CPP',xp:20,
    ...
    secs:[
      ...
      {t:'Droits notifiés IMMÃ‰DIATEMENT (art. 63-1 CPP)',items:['Droit de <b>garder le silence</b>','Droit à un <b>avocat</b> sans délai (loi 22/04/2024 : carence 2h SUPPRIMÃ‰E)','Droit à l\'<b>examen médical</b>','Droit d\'aviser un <b>proche</b> et son employeur','Droit à un <b>interprète</b>','<b>Accusé de réception</b> signé par le GAV']},
    ],
    traps:['Heure de GAV = heure d\'APPRÃ‰HENSION (pas arrivée au commissariat)','Délai de carence 2h SUPPRIMÃ‰ depuis loi 22/04/2024 → avocat SANS délai','Avis PR = IMMÃ‰DIAT (pas dans les 3h !)'],
    keys:['Art. 62-2 : 6 objectifs cumulatifs','Art. 63-1 : notification IMMÃ‰DIATE des droits','Loi 22/04/2024 : fin du délai de carence avocat']},
  {id:'L302',em:'âš¡',name:'GAV Régimes Dérogatoires',ref:'Art. 706-88 CPP',xp:20,
    intro:'Les infractions graves disposent de régimes de GAV prolongée, avec des garanties renforcées impliquant le JLD.',
    secs:[
      {t:'Tableau des durées selon le régime',table:{th:['Régime','Durée max','Autorité prolongation'],rows:[['Droit commun','48h (24h + 24h)','PR (écrite et motivée)'],['Criminalité organisée','96h (4Ã—24h)','PR puis JLD (>48h)'],['Terrorisme','144h (6Ã—24h)','PR puis JLD (>48h)'],['Mineur 13-16 ans','24h non renouvelable','PR (sauf CO ou ≥5 ans)']]}},
  ...
  {id:'L303',em:'ðŸ‘¶',name:'GAV des Mineurs',ref:'Art. L413-6 CJPM',xp:15,
    ...
    secs:[
      {t:'Ã‚ge et responsabilité pénale',items:['<b>Moins de 10 ans</b> : irresponsabilité pénale totale','<b>10 à 13 ans</b> : présomption irréfragable d\'irresponsabilité — retenue judiciaire max 12h','<b>13 à 18 ans</b> : responsabilité pénale atténuée (CJPM 2021)']},
    ...
    traps:['Ordonnance 1945 = OBSOLÃˆTE depuis le 30/09/2021 → CJPM seul applicable','Moins de 13 ans : PAS de GAV — retenue judiciaire 12h MAXIMUM'],
...
{id:'ch4',num:'04',title:'Perquisitions & Auditions',sub:'Procédures · Lieux protégés · Audition libre',color:'#8b5cf6',bg:'rgba(139,92,246,.12)',icon:'ðŸ”',
lessons:[
...
{id:'ch5',num:'05',title:'Droit Pénal Général',sub:'Infractions · Tentative · Complicité · Responsabilité',color:'#10b981',bg:'rgba(16,185,129,.1)',icon:'ðŸ“œ',
lessons:[
  {id:'L501',em:'ðŸ“œ',name:'Ã‰léments constitutifs d\'une infraction',ref:'Art. 111-1 CP',xp:15,
    ...
    secs:[
      {t:'Les 3 éléments constitutifs',items:['<b>Ã‰lément légal (L)</b> : le texte qui incrimine le comportement. Sans texte, pas d\'infraction (principe de légalité — art. 111-2 CP). Toujours citer l\'article exact.','<b>Ã‰lément matériel (A)</b> : l\'acte concret réalisé. Acte positif, omission, résultat, lien de causalité. Décrire précisément les faits.','<b>Ã‰lément moral (M)</b> : l\'intention (dol général) ou la faute (imprudence, négligence). Le tribunal doit pouvoir en retrouver la preuve dans le PV.']},
  ...
  {id:'L502',em:'ðŸŽ¯',name:'Tentative & Complicité',ref:'Art. 121-5, 121-7 CP',xp:15,
    ...
    secs:[
      {t:'La tentative (art. 121-5 CP)',items:['<b>Définition</b> : commencement d\'exécution + absence de désistement volontaire','<b>Crime</b> : tentative TOUJOURS punissable (même peine que consommé)','<b>Délit</b> : tentative punissable UNIQUEMENT si le texte le prévoit','<b>Contravention</b> : tentative JAMAIS punissable','<b>Désistement volontaire AVANT consommation</b> = IMPUNITÃ‰ (actes déjà commis restent punis)']},
  ...
  {id:'L503',em:'ðŸ›¡ï¸',name:'Causes d\'Irresponsabilité Pénale',ref:'Art. 122-1 à 122-7 CP',xp:15,
    ...
    secs:[
      ...
      {t:'Ã‰tat de nécessité vs Légitime défense',items:['<b>Légitime défense</b> : agression d\'un tiers → riposte','<b>Ã‰tat de nécessité</b> : danger actuel (pas d\'agression humaine nécessaire) → acte nécessaire et proportionné']},
    ],
...
{id:'ch6',num:'06',title:'Infractions contre les Personnes',sub:'Homicide · Violences · Viol · Séquestration',color:'#ef4444',bg:'rgba(239,68,68,.1)',icon:'ðŸ©¸',
lessons:[
  {id:'L601',em:'âš–ï¸',name:'Atteintes à la vie',ref:'Art. 221-1 à 221-6 CP',xp:20,
    intro:'Les atteintes à la vie forment le cÅ“ur du droit pénal spécial. Distinguer meurtre, assassinat, homicide involontaire et violences mortelles est essentiel pour une qualification juste.',
    secs:[
      {t:'Tableau comparatif',table:{th:['Infraction','Article','Peine','Ã‰lément moral'],rows:[['Meurtre','221-1 CP','30 ans RC','Intention de tuer (animus necandi)'],['Assassinat','221-3 CP','Perpétuité','Meurtre + PRÃ‰MÃ‰DITATION'],['Empoisonnement','221-5 CP','30 ans RC','Connaissance + intention + substance mortifère'],['Homicide involontaire','221-6 CP','3 ans / 45kâ‚¬','FAUTE d\'imprudence (sans intention)'],['Violences mortelles','222-7 CP','15 ans RC','Intention de BLESSER (pas de tuer)'],['Non-assistance','223-6 al.2 CP','5 ans / 75kâ‚¬','Abstention volontaire']]}},
  ...
  {id:'L602',em:'ðŸ‘Š',name:'Violences & Atteintes sexuelles',ref:'Art. 222-7 à 222-33 CP',xp:15,
    ...
    secs:[
      {t:'Ã‰chelle des violences selon ITT',table:{th:['Résultat','Article','Nature','Peine base'],rows:[['Sans ITT (gifle)','R624-1 CP','Contravention','3 750 â‚¬'],['ITT ≤ 8 jours','R625-1 CP','Contravention','1 500 â‚¬'],['ITT > 8 jours','222-11 CP','Délit','3 ans / 45kâ‚¬'],['Mutilation/infirmité','222-9 CP','Crime','10 ans RC'],['Mort sans intention','222-7 CP','Crime','15 ans RC']]}},
      {t:'Atteintes sexuelles — critère clé',items:['<b>VIOL (222-23 CP)</b> : pénétration sexuelle OU acte bucco-génital — <b>15 ans RC</b>','<b>Agression sexuelle (222-27 CP)</b> : acte sexuel SANS pénétration — <b>7 ans + 100kâ‚¬</b>','<b>Critère unique</b> : la PÃ‰NÃ‰TRATION fait basculer de délit à crime','Aggravant mineur < 15 ans : viol → 20 ans RC / Agression → 10 ans']},
    ],
    ...
    keys:['ITT > 8j = 222-11 délit. ITT ≤ 8j = contravention','Viol vs agression : critère = PÃ‰NÃ‰TRATION']},
]},

{id:'ch7',num:'07',title:'Infractions contre les Biens',sub:'Vol · Escroquerie · Recel · Stups',color:'#3b82f6',bg:'rgba(59,130,246,.1)',icon:'ðŸ’¼',
lessons:[
  {id:'L701',em:'ðŸ’¼',name:'Vol, Escroquerie & ADB',ref:'Art. 311-1, 313-1, 314-1 CP',xp:15,
    ...
    secs:[
      {t:'Tableau comparatif clé',table:{th:['Infraction','Article','Mode','Peine'],rows:[['Vol','311-1 CP','SOUSTRAIT (sans remise)','3 ans / 45kâ‚¬'],['Extorsion','312-1 CP','DONNE sous CONTRAINTE','7 ans + 100kâ‚¬'],['Escroquerie','313-1 CP','DONNE suite à TROMPERIE','5 ans / 375kâ‚¬'],['Abus de confiance','314-1 CP','CONFIÃ‰ + DÃ‰TOURNÃ‰','3 ans / 375kâ‚¬'],['Chantage','312-10 CP','DONNE sous menace révélation','5 ans / 75kâ‚¬']]}},
      ...
      {t:'Recel (art. 321-1 CP)',items:['Dissimuler, détenir, transmettre ou bénéficier du produit d\'un crime ou délit','Infraction <b>CONTINUE</b> et <b>AUTONOME</b>','Exige la <b>connaissance</b> de l\'origine frauduleuse','Peine : 5 ans + 375kâ‚¬ / habituel : 10 ans + 750kâ‚¬']},
    ],
    traps:['Vol en bande organisée = CRIME (15 ans RC), pas délit ! Piège classique.','ADB : la remise doit être PRÃ‰ALABLE et LICITE (puis détournement)'],
    keys:['Vol = soustrait. Escroquerie = tromperie → remise. ADB = confié puis détourné','Vol en BO = CRIME (311-9)']},
  {id:'L702',em:'ðŸ’Š',name:'Stupéfiants & Infractions Routières',ref:'Art. L3421-1 CSP, L234-1 C.route',xp:10,
    ...
    secs:[
      {t:'Stupéfiants',table:{th:['Infraction','Article','Peine'],rows:[['Usage illicite','L3421-1 CSP','1 an + 3 750 â‚¬'],['Détention/transport','222-37 CP','10 ans + 7,5Mâ‚¬'],['Trafic organisé','222-34 CP','30 ans RC + 7,5Mâ‚¬']]}},
      {t:'Alcool au volant',items:['<b>Taux 0,50-0,80 g/l</b> : contravention (135 â‚¬ + 6 pts)','<b>Taux ≥ 0,80 g/l</b> : DÃ‰LIT — 2 ans + 4 500 â‚¬ (art. L234-1 C.route)','<b>Stups</b> : pas de seuil — TOUTE présence = DÃ‰LIT (L235-1 C.route)','<b>Cumul alcool + stups</b> : 3 ans + 9 000 â‚¬']},
    ],
...
{id:'ch8',num:'08',title:'Procédures Spéciales & CO',sub:'Criminalité organisée · Mineurs · Fichiers',color:'#f59e0b',bg:'rgba(245,158,11,.1)',icon:'ðŸ•µï¸',
lessons:[
  {id:'L801',em:'ðŸ•µï¸',name:'Techniques Spéciales d\'Enquête',ref:'Art. 100, 230-32, 706-81 CPP',xp:20,
    ...
    keys:['Ã‰coutes : JI en instruction / JLD en préliminaire','Géoloc : PR 15j → JLD 1 mois','Infiltration : PR ou JI, 4 mois CO']},
...
{id:'ch9',num:'09',title:'Libertés & CEDH',sub:'Droits fondamentaux · Présomption d\'innocence',color:'#14b8a6',bg:'rgba(20,184,166,.1)',icon:'ðŸ›ï¸',
lessons:[
  {id:'L901',em:'ðŸ›ï¸',name:'Droits fondamentaux & CEDH',ref:'Constitution, DDHC, CEDH',xp:15,
    intro:'Les droits fondamentaux encadrent l\'action de l\'OPJ. Toute violation peut entraîner des nullités de procédure et des condamnations de l\'Ã‰tat devant la CEDH.',
    secs:[
...
{id:'ch10',num:'10',title:'Prescription, Récidive & Alternatives',sub:'Délais · Réitération · Composition pénale',color:'#6366f1',bg:'rgba(99,102,241,.1)',icon:'â³',
lessons:[
  {id:'L1001',em:'â³',name:'Prescription de l\'Action Publique',ref:'Art. 7-9 CPP (loi 27/02/2017)',xp:10,
    ...
    secs:[
      ...
      {t:'Interruption vs Suspension',items:['<b>Interruption</b> : REMET Ã€ ZÃ‰RO le délai (acte d\'instruction, réquisitoire)','<b>Suspension</b> : arrête momentanément (obstacle légitime), reprise au même point','Exemple : acte d\'enquête en cours d\'prescription = interruption → nouveau délai repart']},
    ],
  ...
  {id:'L1002',em:'ðŸ”„',name:'Récidive & Alternatives aux Poursuites',ref:'Art. 132-8 à 132-16 CP, Art. 41-1 CPP',xp:15,
    ...
    traps:['Récidive = condamnation DÃ‰FINITIVE préalable. Réitération = pas de condition.','CRPC : impossible pour les crimes et pour les mineurs.'],
...
/* â•â•â• CH11 — CONTRÃ”LES D'IDENTITÃ‰ â•â•â• */
{id:'ch11',num:'11',title:'Contrôles & Vérifications d\'identité',sub:'Art. 78-1 à 78-6 CPP · Ã‰trangers · Fouilles',color:'#0ea5e9',bg:'rgba(14,165,233,.1)',icon:'ðŸªª',
lessons:[
  {id:'L1101',em:'ðŸªª',name:'Contrôle d\'identité — Art. 78-2 CPP',ref:'Art. 78-2 CPP',xp:15,
    ...
    traps:['Contrôle sur la seule "apparence" ethnique = faute lourde de l\'Ã‰tat (Cour de cass. 9 nov. 2016)','Art. 78-3 : 4h max de rétention AVANT toute GAV — les délais ne se cumulent pas'],
    keys:['8 cas limitatifs d\'art. 78-2','Vérification d\'identité = 4h max, avis PR immédiat','Profilage ethnique = illicite et constitutif de faute de l\'Ã‰tat']},
  {id:'L1102',em:'ðŸŒ',name:'Ã‰trangers — Titre de séjour & Mesures d\'éloignement',ref:'CESEDA · Art. 78-2 CPP',xp:15,
    ...
    secs:[
      ...
      {t:'Mesures d\'éloignement — tableau comparatif',table:{th:['Mesure','Auteur','Base légale','Effet'],rows:[
        ...
        ['Reconduite à la frontière','Préfet','L511-1','Ã‰loignement forcé immédiat'],
        ['Expulsion','Préfet/JA','L521-1 CESEDA','Atteinte à l\'ordre public grave'],
        ['Extradition','Gouvernement','Art. 696 CPP','Remise à Ã‰tat étranger sur demande']]}},
...
{id:'ch12',num:'12',title:'Mesures Coercitives & Mandats',sub:'CJ · ARSE · DP · 4 Mandats',color:'#8b5cf6',bg:'rgba(139,92,246,.1)',icon:'â›“ï¸',
lessons:[
  {id:'L1201',em:'ðŸ“‹',name:'Les 4 Mandats de Justice',ref:'Art. 122-131 CPP',xp:20,
    ...
    secs:[
      ...
      {t:'Mandat de recherche — Art. 122-4 CPP',items:[
        'Ã‰mis par le PR (pas le JI) en enquête préliminaire',
  ...
  {id:'L1202',em:'âš–ï¸',name:'Contrôle Judiciaire — 17 Obligations',ref:'Art. 138 CPP',xp:20,
  ...
  {id:'L1203',em:'ðŸ”—',name:'ARSE & Détention Provisoire',ref:'Art. 142-5, 143-1 CPP',xp:20,
    ...
    secs:[
      {t:'ARSE (Assignation à Résidence avec Surveillance Ã‰lectronique)',items:[
...
{id:'ch13',num:'13',title:'Enquête Patrimoniale & Saisies',sub:'Saisies · Confiscations · Blanchiment',color:'#f59e0b',bg:'rgba(245,158,11,.1)',icon:'ðŸ’°',
lessons:[
  {id:'L1301',em:'ðŸ’°',name:'Enquête Patrimoniale & Saisies',ref:'Art. 131-21 CP · Art. 706-141 CPP',xp:20,
    ...
    secs:[
      ...
      {t:'Non-justification de ressources & Blanchiment',items:[
        ...
        'Blanchiment aggravé (bande organisée) : 10 ans + 750 000 â‚¬',
    ...
    keys:['Art. 131-21 = 9 alinéas de confiscation à maîtriser','Saisie conservatoire = JLD/JI requis','Blanchiment : 5 ans/375kâ‚¬, aggravé BO : 10 ans/750kâ‚¬']},
]},
];
