const FB=[
  {id:"F01",fam:"vie",nm:"MEURTRE",ref:"Art. 221-1 CP",qual:"Crime",pn:"30 ans RC",em:"âš–ï¸",L:"Donner volontairement la mort Ã  autrui (art. 221-1).",A:"Acte positif sur personne vivante, distincte de l'auteur, lien causal avec le dÃ©cÃ¨s. Tentative : oui.",M:"Intentionnel â€” animus necandi (intention homicide).",E:[{a:"Mineur <15 ans",p:"PerpÃ©tuitÃ©",r:"221-4 1Â°"},{a:"PDAP",p:"PerpÃ©tuitÃ©",r:"221-4 4Â°"},{a:"PrÃ©mÃ©ditation = ASSASSINAT",p:"PerpÃ©tuitÃ©",r:"221-3"},{a:"Bande organisÃ©e",p:"PerpÃ©tuitÃ©",r:"221-4 8Â°"}],cf:"Assassinat (221-3) = meurtre + PRÃ‰MÃ‰DITATION. Violences mortelles (222-7) = intention de blesser seulement.",pg:"Confondre meurtre et violences mortelles (222-7 : 15 ans RC, pas d'intention de tuer)."},
  {id:"F02",fam:"vie",nm:"HOMICIDE INVOLONTAIRE",ref:"Art. 221-6 CP",qual:"DÃ©lit",pn:"3 ans / 45 000â‚¬",em:"ðŸš—",L:"Causer la mort par maladresse, imprudence, nÃ©gligence ou MOSP.",A:"Faute, lien causal, mort. Tentative : non.",M:"NON intentionnel â€” faute.",E:[{a:"Violation MOSP",p:"5 ans / 75kâ‚¬",r:"221-6 al.2"},{a:"Alcool + conduite",p:"7 ans / 100kâ‚¬",r:"221-6-1"}],cf:"Meurtre (221-1) = intention de tuer. HI = faute sans intention.",pg:"PAS d'intention de tuer â€” c'est l'Ã©lÃ©ment distinctif clÃ©."},
  {id:"F03",fam:"integrite",nm:"VIOLENCES VOLONTAIRES",ref:"Art. 222-7 Ã  222-16 CP",qual:"Variable",pn:"Variable selon ITT",em:"ðŸ‘Š",L:"R624-1 (sans ITT), R625-1 (ITTâ‰¤8j), 222-11 (ITT>8j), 222-9 (mutilation), 222-7 (mort).",A:"Acte positif de violence, rÃ©sultat. Tentative : non.",M:"Intentionnel â€” conscience d'affecter l'intÃ©gritÃ©.",E:[{a:"PDAP/mineur/arme",p:"Aggravation",r:"222-12"},{a:"Mort sans intention",p:"15 ans RC",r:"222-7"}],cf:"Meurtre = intention de tuer. Violences = intention de blesser.",pg:"L'Ã©chelle pÃ©nale dÃ©pend de l'ITT fixÃ©e par le mÃ©decin lÃ©giste."},
  {id:"F04",fam:"integrite",nm:"VIOL",ref:"Art. 222-23 CP",qual:"Crime",pn:"15 ans RC",em:"ðŸ”´",L:"PÃ©nÃ©tration sexuelle ou acte bucco-gÃ©nital par violence, contrainte, menace ou surprise.",A:"PÃ©nÃ©tration ou acte bucco-gÃ©nital, sans consentement. Tentative : oui.",M:"Intentionnel â€” conscience d'imposer un acte non consenti.",E:[{a:"Mineur <15 ans",p:"20 ans RC",r:"222-24 2Â°"},{a:"Mort victime",p:"30 ans RC",r:"222-25"}],cf:"Viol = PÃ‰NÃ‰TRATION (crime). Agression sexuelle = sans pÃ©nÃ©tration (dÃ©lit).",pg:"Actes bucco-gÃ©nitaux = viol (crime 15 ans) depuis la jurisprudence."},
  {id:"F05",fam:"biens",nm:"VOL",ref:"Art. 311-1 CP",qual:"DÃ©lit",pn:"3 ans / 45 000â‚¬",em:"ðŸ‘œ",L:"Soustraction frauduleuse de la chose d'autrui.",A:"Soustraction, chose meuble, appartenant Ã  autrui. Tentative : oui.",M:"Intentionnel â€” volontÃ© de se comporter en propriÃ©taire.",E:[{a:"Violence",p:"5-10 ans",r:"311-5/6"},{a:"Arme",p:"10 ans",r:"311-8"},{a:"Bande organisÃ©e",p:"15 ans RC",r:"311-9"}],cf:"Escroquerie = tromperie â†’ remise. Vol = soustraction.",pg:"Vol en bande organisÃ©e = CRIME (15 ans RC), pas dÃ©lit !"},
  {id:"F06",fam:"biens",nm:"ESCROQUERIE",ref:"Art. 313-1 CP",qual:"DÃ©lit",pn:"5 ans / 375 000â‚¬",em:"ðŸŽ­",L:"Obtenir une remise par faux nom, fausse qualitÃ© ou manÅ“uvres frauduleuses.",A:"Tromperie, remise, prÃ©judice. Tentative : oui.",M:"Intentionnel.",E:[{a:"Bande organisÃ©e",p:"10 ans + 1Mâ‚¬",r:"313-2"}],cf:"Vol : PREND. Escroquerie : DONNE suite Ã  tromperie.",pg:"Simples mensonges â‰  escroquerie (il faut des manÅ“uvres frauduleuses)."},
  {id:"F07",fam:"biens",nm:"ABUS DE CONFIANCE",ref:"Art. 314-1 CP",qual:"DÃ©lit",pn:"3 ans / 375 000â‚¬",em:"ðŸ¤",L:"DÃ©tourner un bien remis Ã  charge de le rendre.",A:"Remise prÃ©alable licite, dÃ©tournement, prÃ©judice. Tentative : non.",M:"Intentionnel.",E:[{a:"Mandataire de justice",p:"7 ans + 750kâ‚¬",r:"314-2"}],cf:"ADB : bien CONFIÃ‰ puis DÃ‰TOURNÃ‰. Vol : soustrait sans remise.",pg:"ADB exige remise PRÃ‰ALABLE et LICITE â€” critÃ¨re fondamental."},
  {id:"F08",fam:"biens",nm:"RECEL",ref:"Art. 321-1 CP",qual:"DÃ©lit",pn:"5 ans / 375 000â‚¬",em:"ðŸ“¦",L:"Dissimuler, dÃ©tenir, transmettre ou bÃ©nÃ©ficier du produit d'un crime/dÃ©lit.",A:"Acte matÃ©riel, objet frauduleux d'un tiers. Tentative : non.",M:"Intentionnel â€” connaissance de l'origine frauduleuse.",E:[{a:"Habituel/professionnel",p:"10 ans + 750kâ‚¬",r:"321-2"}],cf:"Recel â‰  complicitÃ©. Recel = infraction autonome continue.",pg:"Le recel est une infraction CONTINUE (persiste tant que dÃ©tenu)."},
  {id:"F09",fam:"autorite",nm:"OUTRAGE",ref:"Art. 433-5 CP",qual:"DÃ©lit",pn:"1 an / 15 000â‚¬",em:"ðŸ’¬",L:"Paroles/gestes/menaces non publics Ã  PDAP.",A:"Expression outrageante, NON publique, DIRECTEMENT Ã  la personne.",M:"Intentionnel â€” connaissance qualitÃ© + conscience du caractÃ¨re outrageant.",E:[{a:"En rÃ©union",p:"2 ans + 30kâ‚¬",r:"433-5 al.3"}],cf:"Outrage = VERBAL, DIRECT. RÃ©bellion = PHYSIQUE.",pg:"Si PUBLIC = injure (loi 1881, pas le CP). PiÃ¨ge classique."},
  {id:"F10",fam:"autorite",nm:"RÃ‰BELLION",ref:"Art. 433-6 CP",qual:"DÃ©lit",pn:"1 an / 15 000â‚¬",em:"âœŠ",L:"RÃ©sistance violente Ã  PDAP lors d'un acte lÃ©gitime.",A:"RÃ©sistance VIOLENTE et ACTIVE lors d'un acte lÃ©gitime. Tentative : non.",M:"Intentionnel.",E:[{a:"Arme",p:"2 ans + 30kâ‚¬",r:"433-8"}],cf:"RÃ©bellion = PHYSIQUE. RÃ©sistance PASSIVE â‰  rÃ©bellion.",pg:"Se laisser tomber au sol = rÃ©sistance passive â‰  rÃ©bellion."},
  {id:"F11",fam:"stups",nm:"USAGE STUPÃ‰FIANTS",ref:"Art. L3421-1 CSP",qual:"DÃ©lit",pn:"1 an / 3 750â‚¬",em:"ðŸŒ¿",L:"Usage illicite de substance classÃ©e.",A:"Usage illicite, substance classÃ©e. Tentative : non.",M:"Intentionnel.",E:[{a:"â€”",p:"â€”",r:"â€”"}],cf:"Usage (L3421-1) = 1 an. DÃ©tention/trafic (222-37) = 10 ans.",pg:"AFD possible : 200 â‚¬."},
  {id:"F12",fam:"route",nm:"CONDUITE ALCOOLIQUE",ref:"Art. L234-1 C.route",qual:"DÃ©lit",pn:"2 ans / 4 500â‚¬",em:"ðŸº",L:"Taux â‰¥ 0,80 g/l sang ou â‰¥ 0,40 mg/l air expirÃ©.",A:"Conducteur, taux dÃ©lictuel prouvÃ©.",M:"Intentionnel â€” volontÃ© de conduire aprÃ¨s consommation.",E:[{a:"Cumul stups",p:"3 ans + 9kâ‚¬",r:"L235-1 al.2"}],cf:"0,50-0,80 g/l = contravention. â‰¥ 0,80 g/l = DÃ‰LIT.",pg:"Stups : PAS DE SEUIL â€” toute prÃ©sence = dÃ©lit."},
  {id:"F13",fam:"biens",nm:"EXTORSION",ref:"Art. 312-1 CP",qual:"Crime",pn:"7 ans / 100 000â‚¬",em:"ðŸ’°",L:"Obtenir par violence/menace/contrainte une remise.",A:"Contrainte, remise par la victime. Tentative : oui.",M:"Intentionnel.",E:[{a:"Arme",p:"10 ans",r:"312-2"},{a:"Bande organisÃ©e",p:"20 ans RC",r:"312-6"}],cf:"Vol : SOUSTRAIT. Extorsion : REMET sous contrainte physique.",pg:"Chantage = menace de RÃ‰VÃ‰LATION. Extorsion = contrainte physique."},
  {id:"F14",fam:"stups",nm:"TRAFIC STUPÃ‰FIANTS",ref:"Art. 222-34 Ã  222-40 CP",qual:"Crime/DÃ©lit",pn:"10 Ã  30 ans RC",em:"ðŸ’Š",L:"Participation Ã  un rÃ©seau de distribution de substances classÃ©es.",A:"Participation active, substances classÃ©es, rÃ´le variable.",M:"Intentionnel â€” connaissance nature illicite.",E:[{a:"Bande organisÃ©e",p:"30 ans RC + 7,5Mâ‚¬",r:"222-34"}],cf:"Usage (1 an) vs transport/dÃ©tention (10 ans) vs trafic CO (30 ans RC).",pg:"Trafic en BO = 30 ans RC â€” peine criminelle maximale."},
  {id:"F15",fam:"autorite",nm:"CORRUPTION PASSIVE",ref:"Art. 432-11 CP",qual:"Crime",pn:"10 ans / 1 000 000â‚¬",em:"ðŸ’¼",L:"Agent public qui sollicite/agrÃ©e des avantages indus liÃ©s Ã  sa fonction.",A:"Offre/demande, avantage indu, rapport avec la fonction.",M:"Intentionnel.",E:[{a:"Trafic d'influence",p:"10 ans",r:"432-11 al.2"}],cf:"Corruption passive (agent) vs active (particulier, art. 433-1).",pg:"Corruption passive (agent) â‰  active (particulier qui propose)."},
];
...
function loadState(){
  try{
    ...
    if(!s.v||s.v<STATE_VERSION){
      // Migration douce : prÃ©server XP et progression
...
function navigateTo(page){
  ...
  const titles={home:'OPJ Elite',lecons:'Mes LeÃ§ons',revision:'RÃ©vision',examen:'Mode Examen',profil:'Mon Profil',pro:'OPJ Elite PRO'};
...
function renderHome(){
  ...
  if(el('h-score'))el('h-score').textContent=acc!==null?acc+'%':'â€”';
  // Dues
...
function renderChapterProgress(){if(typeof CHAPTERS==='undefined'||!CHAPTERS)return;
  ...
  }).join('')+`<div style="margin-top:10px;text-align:center"><button class="btn btn-ghost btn-sm" onclick="navigateTo('lecons')" style="font-size:11px">Voir toutes les leÃ§ons â†’</button></div>`;
}

function renderWeakWidget(){
  const el=document.getElementById('h-weak-widget');if(!el)return;
  const THEMES_DEF=[
    {cat:'GAV',name:'Garde Ã  Vue',em:'ðŸ”’'},
    ...
    {cat:'LIBERTES',name:'LibertÃ©s',em:'ðŸ›ï¸'},
  ...
  el.innerHTML=`<div class="weak-widget">
    <div class="weak-widget-title">âš ï¸ Zones Ã  renforcer</div>
...
function renderLecons(){
  ...
  const el=id=>document.getElementById(id);
  if(el('lec-global-prog'))el('lec-global-prog').textContent=done+' leÃ§on'+(done>1?'s':'')+' vue'+(done>1?'s':'')+' sur '+totalLessons;
      ...
      <div class="chapter-lessons" id="lessons-${ch.id}">
        ${ch.lessons.map(l=>`<div class="lesson-item" onclick="openLesson('${l.id}');event.stopPropagation()">
          ...
          <div class="lesson-inf">
            ...
            <div class="lesson-meta">${l.ref} Â· +${l.xp} XP</div>
          </div>
...
function openLesson(id){
  ...
  if(lesson.traps?.length)lesson.traps.forEach(t=>html+=`<div class="lesson-trap"><div class="lesson-trap-lbl">âš ï¸ PiÃ¨ge d'examen</div><div class="lesson-trap-txt">${t}</div></div>`);
  ...
  html+=`<div style="margin-top:18px">
    <button class="btn btn-p" onclick="markLessonDone('${id}')" style="${isDone?'background:var(--ok-bg);border:1px solid var(--ok);color:var(--ok)':''}">
      ${isDone?'âœ… LeÃ§on maÃ®trisÃ©e â€” Relire':'âœ“ Marquer comme vue Â· +'+lesson.xp+' XP'}
    </button>
...
function markLessonDone(id){
  if(!S.lessons[id]){
    ...
    save();showToast('âœ… LeÃ§on vue ! +'+(lesson?.xp||10)+' XP','ok');haptic(50);
  }
...
function renderRevThemes(){
  const THEMES=[
    ...
    {cat:'RECIDIVE',name:'RÃ©cidive',em:'ðŸ”„',color:'#f97316'},
    {cat:'LEGDEF',name:'LÃ©gitime DÃ©fense',em:'ðŸ›¡ï¸',color:'#14b8a6'},
    {cat:'NULLITES',name:'NullitÃ©s',em:'ðŸš«',color:'#64748b'},
    {cat:'INSTRUCTION',name:'Instruction',em:'ðŸ›ï¸',color:'#0ea5e9'},
    {cat:'INFRACTIONS',name:'Infractions',em:'âš¡',color:'#e11d48'},
    {cat:'LIBERTES',name:'LibertÃ©s',em:'ðŸ›ï¸',color:'#14b8a6'},
    {cat:'CDO',name:'CriminalitÃ© Org.',em:'ðŸ•µï¸',color:'#a855f7'},
  ...
  const setV=(id,v)=>{const e=document.getElementById(id);if(e)e.textContent=v;};
  setV('qs-due',dueQ||'0');
  setV('qs-total',totalQ||'â€”');
  setV('qs-acc',seenQ>0?accPct+'%':'â€”');
  setV('rev-due-count',dueQ>0?`${dueQ} question${dueQ>1?'s':''} Ã  rÃ©viser maintenant`:'Tout est Ã  jour âœ…');

  const themes=THEMES.filter(t=>QB.some(q=>q.cat===t.cat));
  const thCount=document.getElementById('qcm-themes-count');
  if(thCount)thCount.textContent=themes.length+' thÃ¨mes';
    ...
    return`<div class="theme-card2" onclick="startSession('${t.cat}')" style="animation:fadeUp .15s ${i*0.025}s both;--tc:${t.color}">
      ...
      <div class="theme-card2-body">
        ...
        <div class="theme-card2-meta">
          ...
          ${due>0?`<span class="theme-due-badge">âš¡ ${due} Ã  revoir</span>`:''}
          ${completed?`<span class="theme-done-badge">âœ“ ComplÃ©tÃ©</span>`:''}
        </div>
...
function renderBubbles(){
  ...
  const FAMILIES={
    ...
    integrite:{label:'IntÃ©gritÃ©',     em:'ðŸ©¸',color:'#f97316',grad:'linear-gradient(135deg,#f97316,#ea580c)'},
    biens:    {label:'Biens',         em:'ðŸ’°',color:'#f59e0b',grad:'linear-gradient(135deg,#f59e0b,#d97706)'},
    autorite: {label:'AutoritÃ©',      em:'ðŸ›¡ï¸',color:'#3b82f6',grad:'linear-gradient(135deg,#3b82f6,#2563eb)'},
    stups:    {label:'StupÃ©fiants',   em:'ðŸ’Š',color:'#a855f7',grad:'linear-gradient(135deg,#a855f7,#9333ea)'},
  ...
  if(elSum)elSum.textContent=`${mastered}/${FB.length} maÃ®trisÃ©es Â· ${learning} en cours`;
  ...
  const shortNm=nm=>{
    const map={
      ...
      'RECEL':'Recel','OUTRAGE':'Outrage','RÃ‰BELLION':'RÃ©bellion','USAGE STUPÃ‰FIANTS':'Usage stups',
      ...
      <div class="ft-group-hd">
        ...
        <div class="ft-group-info">
          ...
          <div class="ft-group-prog">
            ...
            <span class="ft-group-cnt" style="color:${allDone?'var(--gold)':fam.color}">${allDone?'â˜… ComplÃ¨te':famMastered+'/'+items.length}</span>
          </div>
        </div>
      </div>
...
function openFiche(id){
  ...
  /* FIX v49 â€” dÃ©placer fiche-ov hors de p-revision (display:none) vers #app */
  ...
  const QUAL_COLORS={
    ...
    'DÃ©lit':       {h:'#3b82f6',bg:'rgba(37,99,235,.1)', grd:'linear-gradient(135deg,rgba(37,99,235,.12),rgba(37,99,235,.04))'},
    'Variable':    {h:'#f59e0b',bg:'rgba(245,158,11,.1)',grd:'linear-gradient(135deg,rgba(245,158,11,.12),rgba(245,158,11,.04))'},
    'Crime/DÃ©lit': {h:'#a855f7',bg:'rgba(168,85,247,.1)',grd:'linear-gradient(135deg,rgba(168,85,247,.12),rgba(168,85,247,.04))'},
  };
  const qc=QUAL_COLORS[f.qual]||QUAL_COLORS['DÃ©lit'];
  const statuses=[
    {s:'',   lbl:'Non vue',    icon:'â—‹', bg:'var(--bg-3)',     c:'var(--t3)'},
    {s:'s',  lbl:'Vue âœ“',      icon:'â—', bg:'rgba(37,99,235,.12)', c:'#3b82f6'},
    {s:'m',  lbl:'MaÃ®trisÃ©e â˜…',icon:'â˜…', bg:'rgba(212,175,55,.12)','c':'var(--gold)'},
  ];
  ...
  <div class="fo-header" style="background:${qc.grd};border-bottom:1px solid ${qc.h}22">
    <div class="fo-header-top">
      ...
      <div class="fo-header-right">
        ...
        <span class="fo-fam-badge">${f.fam||'â€”'}</span>
      </div>
    </div>
  ...
  <div class="fo-section">
    <div class="fo-section-hd">ðŸ“ Ã‰lÃ©ments constitutifs</div>
  ...
  /* AGGRAVANTES */
  const aggs=(f.E||[]).filter(e=>e.a&&e.a!=='â€”');
  if(aggs.length){
  ...
  if(f.pg){
    h+=`<div class="fo-piege">
      <div class="fo-piege-hd">âš ï¸ PiÃ¨ge d'examen</div>
...
function setFiche(id,s){
  const p=S.fs[id];
  if(s==='m'&&p!=='m'){addXP(15);showToast('+15 XP â€” Fiche maÃ®trisÃ©e !','ok');}
...
function startSession(cat){
  ...
  if(!pool.length){showToast('Aucune question pour ce thÃ¨me','err');return;}
...
/* â”€â”€â”€ v50 â€” MÃ©lange des rÃ©ponses QCM â”€â”€â”€ */
function shuffleQ(q){
  /* Associer chaque option Ã  son index original */
...
/* Shuffle dÃ©terministe (mÃªme graine = mÃªme rÃ©sultat) pour QDJ */
...
function finishSession(){
  ...
  document.getElementById('qr-detail').textContent=S.qcm.stats.ok+'/'+tot+' bonnes rÃ©ponses Â· +'+S.qcm.stats.xp+' XP';
  ...
  if(review){
    ...
    if(wrongs.length)review.innerHTML=`<div class="sect-label">Erreurs Ã  retravailler</div>`+wrongs.map(q=>`<div class="lesson-block"><div class="text-sm fw-600 mb4">${q.q}</div><div class="text-xs text-accent font-mono">${q.art}</div></div>`).join('');
  }
...
function runCRPhase(){
  ...
  if(lbl)lbl.textContent=_crPhase===1?'ðŸ“ PrÃ©paration':'ðŸŽ¤ CR oral â€” Ã€ vous !';
...
function renderProfil(){
  ...
  const totalOk=vals.reduce((a,c)=>a+(c.ok||0),0);
  const totalAll=vals.reduce((a,c)=>a+(c.ok||0)+(c.ko||0),0);
  if(el('pr-acc'))el('pr-acc').textContent=totalAll>0?Math.round(totalOk/totalAll*100)+'%':'â€”';
...
function renderRadar28(){
  const labels=['GAV','Flagrance','Mandats','Infractions','LibertÃ©s','ProcÃ©dure'];
...
function resetData(){
  if(!confirm('RÃ©initialiser toute la progression ? Cette action est irrÃ©versible.'))return;
  const name=S.user.name;S=defaultState();S.user.name=name;S.page='home';save();
  navigateTo('home');showToast('Progression rÃ©initialisÃ©e','ok');
}
...
const CR_DOSSIERS=[
{id:1,titre:"Personne griÃ¨vement blessÃ©e",emoji:"ðŸ©¸",cadre:"Flagrance",qual:"Tentative homicide / Violences aggravÃ©es",tags:["Flagrance","Art. 222-1 CP","Urgence"],
faits:"Ã€ 23h15, votre patrouille est appelÃ©e pour une personne inconsciente rue des Acacias. Vous dÃ©couvrez M. MARTIN Thierry, 34 ans, crÃ¢ne fracturÃ©. SAMU en route. TÃ©moin DUPONT RenÃ© signale un suspect masculin, veste rouge, fuite il y a 10 minutes.",
qualification:"Tentative d'homicide volontaire art. 221-1 CP ou violences aggravÃ©es nuit/guet-apens art. 222-8 CP. Cadre : flagrance art. 53 CPP.",
pieges:["Qualifier au plus grave sans attendre le pronostic vital","PrÃ©ciser et justifier le cadre flagrance","Demander autorisation GAV dÃ¨s interpellation","SÃ©curiser la scÃ¨ne : tÃ©moins, traces, vidÃ©osurveillance"],
corrige:"Monsieur le Procureur, OPJ [NOM], brigade [SERVICE], il est [HEURE].\n\nJe vous rends compte de la dÃ©couverte d'une personne griÃ¨vement blessÃ©e rue des Acacias, ce jour Ã  23h15.\n\nQUALIFICATION : Tentative d'homicide volontaire â€” art. 221-1 al.1 CP.\nCADRE : EnquÃªte de flagrance â€” art. 53 CPP.\nFAITS : Victime inconsciente, crÃ¢ne fracturÃ©. TÃ©moin DUPONT RenÃ© signale suspect veste rouge, fuite il y a 10 min.\nACTES RÃ‰ALISÃ‰S : SÃ©curisation scÃ¨ne. Demande SAMU. Recueil dÃ©position DUPONT.\nDEMANDES : Autorisation GAV suspect dÃ¨s interpellation. RÃ©quisitions vidÃ©osurveillance. Avis mÃ©decin lÃ©giste.\n\nJe reste disponible."},
{id:2,titre:"Cambriolage en cours",emoji:"ðŸ ",cadre:"Flagrance",qual:"Vol aggravÃ© â€” Art. 311-4 CP",tags:["Flagrance","Art. 311-4 CP","GAV"],
faits:"Ã€ 02h30, deux individus dans une bijouterie fermÃ©e, vitrine brisÃ©e. Interpellation de SAID Karim, 22 ans : 12 montres + pied de biche. Un complice fuit par les toits. PropriÃ©taire M. CHEN confirme.",
qualification:"Vol aggravÃ© effraction + nuit + rÃ©union â€” art. 311-4 2Â° et 4Â° CP. Flagrance art. 53 CPP.",
pieges:["Cumuler les circonstances aggravantes","Demander perquisition domicile","Signalement complice","Sceller sÃ©parÃ©ment chaque objet"],
corrige:"Monsieur le Procureur, OPJ [NOM], brigade [SERVICE].\n\nVol aggravÃ© effraction + nuit + rÃ©union â€” art. 311-4 2Â° et 4Â° CP.\nFlagrance art. 53 CPP.\n\nSAID Karim interpellÃ© avec 12 montres et pied de biche. Complice en fuite.\n\nDEMANDES : GAV SAID. Perquisition domicile. Signalement complice. RÃ©quisitions camÃ©ra."},
{id:3,titre:"Violences conjugales habituelles",emoji:"ðŸ‘Š",cadre:"PrÃ©liminaire",qual:"Violences habituelles â€” Art. 222-14 CP",tags:["PrÃ©liminaire","Art. 222-14 CP"],
faits:"Mme PETIT Sophie, 31 ans, se prÃ©sente. Violences rÃ©pÃ©tÃ©es sur 6 mois par son conjoint. Certificat mÃ©dical : ITT 5 jours. Main courante en mars. Deux enfants mineurs au domicile.",
qualification:"Violences habituelles sur conjoint, ITT < 8 jours, prÃ©sence enfants â€” art. 222-14 2Â° et 3Â° CP.",
pieges:["HABITUALITÃ‰ art. 222-14 â‰  violences simples","VÃ©rifier si enfants tÃ©moins â†’ aggravante","Pas de perquisition sans accord ou JLD en prÃ©liminaire","RÃ©aliser l'EVVI"],
corrige:"Madame la Procureure, OPJ [NOM].\n\nViolences habituelles sur conjoint, ITT 5 jours, prÃ©sence enfants â€” art. 222-14 2Â° et 3Â° CP.\nPrÃ©liminaire â€” faits sur 6 mois.\n\nDEMANDES : GAV M. LEROY. JLD pour perquisition si refus. Saisine JAF."},
{id:4,titre:"Trafic de stupÃ©fiants â€” bande organisÃ©e",emoji:"ðŸ’Š",cadre:"Flagrance + CO",qual:"Trafic stups bande organisÃ©e â€” Art. 222-34 CP",tags:["CriminalitÃ© organisÃ©e","Art. 222-37 CP","GAV 96h"],
faits:"AprÃ¨s 3 semaines de surveillance, interpellation de GARCIA Pablo, 28 ans. Sur lui : 250g cocaÃ¯ne, 3 500 â‚¬ espÃ¨ces. Sur TRAN Van, 24 ans : 2g usage perso.",
qualification:"GARCIA : trafic cocaÃ¯ne bande organisÃ©e â€” art. 222-34. TRAN : usage â€” L3421-1 CSP.",
pieges:["Distinguer GARCIA (trafiquant) et TRAN (usage)","RÃ©gime dÃ©rogatoire CO","Saisir les avoirs criminels"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nGARCIA : trafic cocaÃ¯ne BO â€” art. 222-34. TRAN : usage â€” L3421-1.\nRÃ©gime CO art. 706-73.\n\nDEMANDES : GAV GARCIA CO 96h JLD. GAV TRAN droit commun. Saisie 3 500 â‚¬."},
{id:5,titre:"Accident â€” dÃ©lit de fuite + alcool",emoji:"ðŸš—",cadre:"Flagrance",qual:"Blessures involontaires aggravÃ©es â€” Art. 222-19-1 CP",tags:["Flagrance","Art. 222-19-1 CP","Alcool"],
faits:"Ã€ 20h30, M. ROUSSEAU Bernard renverse un cycliste en brÃ»lant un feu et prend la fuite. InterpellÃ© 2h30 plus tard. AlcoolÃ©mie : 1,8 g/l. Victime : fracture bassin + commotion â€” ITT 6 semaines.",
qualification:"Blessures involontaires aggravÃ©es alcool + dÃ©lit de fuite â€” art. 222-19-1 CP.",
pieges:["ITT â‰¥ 3 mois â†’ aggravante spÃ©cifique","Cumuler infractions code de la route","Immobiliser le vÃ©hicule"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nBlessures involontaires ITT > 3 mois + dÃ©lit de fuite + alcool 1,8 g/l.\nFlagrance art. 53 CPP.\n\nDEMANDES : GAV ROUSSEAU. RÃ©tention permis. Mise en fourriÃ¨re."},
{id:6,titre:"DÃ©couverte d'un corps",emoji:"ðŸ’€",cadre:"Art. 74 CPP",qual:"Mort suspecte â€” Art. 74 CPP",tags:["Art. 74 CPP","Cause inconnue","MÃ©decin lÃ©giste"],
faits:"Ã€ 06h15, dÃ©couverte d'un homme dÃ©cÃ©dÃ© dans un parc. Aucune trace visible de violence. IdentitÃ© inconnue.",
qualification:"Art. 74 CPP â€” enquÃªte sur les causes de la mort.",
pieges:["Ne pas qualifier avant autopsie","Ne pas ouvrir une information judiciaire soi-mÃªme","PÃ©rimÃ¨tre de sÃ©curitÃ© IMMÃ‰DIAT"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nDÃ©couverte de corps de cause inconnue. Art. 74 CPP.\n\nDEMANDES : RÃ©quisition mÃ©decin lÃ©giste. Identification victime. Votre dÃ©cision sur saisine JI si cause suspecte."},
{id:7,titre:"Vol avec violence en rÃ©union",emoji:"ðŸ‘Š",cadre:"Flagrance",qual:"Vol avec violence en rÃ©union â€” Art. 311-5 CPn",tags:["Flagrance","Art. 311-5 CPn","GAV"],
faits:"Ã€ 14h30, trois individus arrachent tÃ©lÃ©phone et portefeuille en frappant la victime. Un suspect interpellÃ© 200 m plus loin avec le tÃ©lÃ©phone. La victime saigne du nez.",
qualification:"Vol avec violence en rÃ©union â€” art. 311-5 + 311-6 CPn.",
pieges:["VÃ©rifier que la FLAGRANCE est bien caractÃ©risÃ©e","ITT Ã  demander","Co-auteurs en fuite : fiche de recherche"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nVol avec violence en rÃ©union â€” art. 311-5 + 311-6 CPn.\n\nDEMANDES : GAV suspect. ITT victime. Diffusion co-auteurs."},
{id:8,titre:"Violence conjugale â€” retrait de plainte",emoji:"ðŸ‘",cadre:"PrÃ©liminaire",qual:"Violences conjugales â€” Art. 222-11 + 132-80 CPn",tags:["Art. 132-80","Violences conjugales"],
faits:"Ã€ 22h45, intervention pour cris. La femme prÃ©sente un hÃ©matome Ã  l'Å“il. Elle refuse de porter plainte. Le mari nie.",
qualification:"Violences volontaires + aggravante conjoint art. 132-80.",
pieges:["Le retrait de plainte ne met PAS fin aux poursuites","L'OPJ peut procÃ©der mÃªme sans plainte","EVVI obligatoire"],
corrige:"Madame la Procureure, OPJ [NOM].\n\nViolences conjugales â€” art. 222-11 + 132-80 CPn.\n\nVictime refuse plainte â€” procÃ©dure d'initiative. EVVI rÃ©alisÃ©e.\n\nDEMANDES : GAV du mari ? Ã‰loignement ? ITT."},
{id:9,titre:"Trafic de stupÃ©fiants â€” contrÃ´le routier",emoji:"ðŸ”",cadre:"PrÃ©liminaire / Flagrance",qual:"DÃ©tention de stupÃ©fiants â€” Art. 222-37 CPn",tags:["Art. 222-37 CPn","Saisie"],
faits:"Lors d'un contrÃ´le, conducteur nerveux. Coffre : 1 kg rÃ©sine cannabis + 3 500 â‚¬ en liquide. Il nie.",
qualification:"DÃ©tention et transport de stupÃ©fiants â€” art. 222-37.",
pieges:["1 kg + argent liquide = faisceau d'indices de trafic","Saisir les 3 500 â‚¬","Si rÃ©seau suspectÃ© : saisine OCTRIS"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nDÃ©tention et transport stups â€” art. 222-37 CPn. 1 kg cannabis + 3 500 â‚¬.\n\nDEMANDES : GAV. Saisie avoirs. Saisine OCTRIS si rÃ©seau."},
{id:10,titre:"Mineur â€” violences au collÃ¨ge",emoji:"ðŸŽ’",cadre:"CJPM 2021",qual:"Violences ITT > 8 jours â€” Art. 222-11 CPn",tags:["CJPM 2021","Mineur","Art. 222-11"],
faits:"Un Ã©lÃ¨ve de 15 ans a frappÃ© un camarade. La victime est transportÃ©e SAMU (fracture du nez probable). Parents injoignables.",
qualification:"Violences volontaires ITT > 8 jours â€” art. 222-11. CJPM 2021.",
pieges:["NE PAS appliquer les rÃ¨gles des majeurs","Avocat DÃˆS le dÃ©but","Si parents injoignables : administrateur ad hoc"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nViolences ITT > 8 jours MINEUR 15 ans â€” art. 222-11 + CJPM 2021.\n\nDEMANDES : GAV ou retenue ? Saisine JE ? ITT."},
{id:11,titre:"Outrage + rÃ©bellion + violences sur PDAP",emoji:"ðŸš¨",cadre:"Flagrance",qual:"Art. 433-5 + 433-6 + 222-13 CPn",tags:["Art. 433-5 CPn","PDAP"],
faits:"Lors d'un contrÃ´le d'identitÃ©, un homme insulte les agents puis frappe un collÃ¨gue Ã  l'Ã©paule (ITT 0 jour) et tombe volontairement au sol.",
qualification:"Outrage art. 433-5 + RÃ©bellion art. 433-6 + Violences sur PDAP art. 222-13.",
pieges:["RÃ©sistance PASSIVE â‰  rÃ©bellion. Ici il frappe â†’ rÃ©bellion + violences","CUMUL outrage + rÃ©bellion : oui","Demander certificat mÃ©dical pour le collÃ¨gue"],
corrige:"Monsieur le Procureur, OPJ [NOM].\n\nOutrage + RÃ©bellion + Violences sur PDAP â€” art. 433-5, 433-6, 222-13.\n\nDEMANDES : GAV. Certificat mÃ©dical collÃ¨gue blessÃ©."}
];

const PLAN12=[
{s:1,t:"GAV â€” Droit commun",d:"Art. 63-73 CPP"},
{s:2,t:"GAV â€” RÃ©gimes dÃ©rogatoires",d:"CO (706-88) / Terrorisme"},
{s:3,t:"EnquÃªte de flagrance",d:"Art. 53-67 CPP"},
{s:4,t:"EnquÃªte prÃ©liminaire",d:"Art. 75-78-5 CPP"},
{s:5,t:"Perquisitions & Mandats",d:"Art. 56-67 CPP + mandats"},
{s:6,t:"Commission rogatoire",d:"Art. 151-155 CPP"},
{s:7,t:"Droit pÃ©nal gÃ©nÃ©ral",d:"Tentative, complicitÃ©, aggravantes"},
...
{s:10,t:"ProcÃ©dures spÃ©ciales",d:"CO, mineurs, terrorisme"},
{s:11,t:"CR TÃ©lÃ©phonique",d:"Structure, dossiers pratiques"},
