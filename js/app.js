...
.defi-badge{
  ...
  font-family:'DM Mono',monospace;padding:3px 9px;border-radius:100px;
...
.weak-pct{font-family:'DM Mono',monospace;font-size:11px;color:var(--err);font-weight:700;flex-shrink:0}
...
.stat-lbl{font-size:10px;color:var(--t2);margin-top:5px;font-family:'DM Mono',monospace;text-transform:uppercase;letter-spacing:.05em}
...
.chapter-title{font-family:'Bricolage Grotesque',sans-serif;font-size:14px;font-weight:800;color:var(--t1);line-height:1.2}
.chapter-sub{font-size:10px;color:var(--t2);margin-top:2px}
.chapter-prog-txt{font-family:'DM Mono',monospace;font-size:11px;color:var(--gold);font-weight:700}
...
.lesson-meta{font-size:10px;color:var(--t3);margin-top:2px;font-family:'DM Mono',monospace}
.lesson-status{
...
.send-score{
  font-family:'DM Mono',monospace;font-size:64px;font-weight:700;margin:14px 0;
  background:linear-gradient(135deg,var(--accent-l),var(--violet));
  -webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;
  animation:popIn .5s cubic-bezier(.34,1.56,.64,1);
}
.send-title{font-family:'Bricolage Grotesque',sans-serif;font-size:22px;font-weight:900;color:var(--t1);margin-bottom:5px}
...
.theme-meta{font-size:10px;color:var(--t3);margin-top:1px;font-family:'DM Mono',monospace}
...
.theme-pct{font-size:11px;font-weight:700;color:var(--t3);flex-shrink:0;font-family:'DM Mono',monospace}
...
.cart-lbl{font-size:10px;font-weight:700;color:var(--t3);text-transform:uppercase;letter-spacing:.06em;flex-shrink:0;min-width:115px;font-family:'DM Mono',monospace}
...
.print-card-sub{font-size:10px;color:var(--t3);margin-top:2px;font-family:'DM Mono',monospace}
...
.profil-name{
  font-family:'Bricolage Grotesque',sans-serif;font-size:24px;font-weight:900;
...
.ps-val{font-family:'DM Mono',monospace;font-size:20px;font-weight:700;color:var(--accent-l)}
...
.ch-prog-pct{font-family:'DM Mono',monospace;font-size:10px;color:var(--t3);flex-shrink:0;width:30px;text-align:right}
...
.pro-price{
  font-family:'DM Mono',monospace;font-size:44px;font-weight:700;color:var(--gold);
  text-shadow:0 0 20px rgba(212,175,55,.3);
}
...
.proc-group-title{font-size:13px;font-weight:800;color:var(--t1);letter-spacing:.01em;font-family:'Bricolage Grotesque',sans-serif}
.proc-group-sub{font-size:10px;color:var(--t3);font-family:'DM Mono',monospace;margin-top:1px}
.proc-group-badge{font-size:9px;font-weight:700;padding:3px 7px;border-radius:20px;margin-left:auto;flex-shrink:0;font-family:'DM Mono',monospace}
...
.proc-card-num{width:26px;height:26px;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:800;font-family:'DM Mono',monospace;flex-shrink:0}
...
.proc-card-ref{font-size:10px;color:var(--t3);font-family:'DM Mono',monospace;margin-top:2px}
...
.proc-summary-txt{font-size:10px;font-weight:700;font-family:'DM Mono',monospace;color:var(--t2);white-space:nowrap}

/* ══ LP CARDS v33 ══ */
.lp-header{padding:16px 0 12px;margin-bottom:4px}
.lp-header-title{font-size:18px;font-weight:900;color:var(--t1);font-family:'Bricolage Grotesque',sans-serif}
.lp-header-sub{font-size:11px;color:var(--t3);margin-top:3px;font-family:'DM Mono',monospace}
...
.lp-progress-txt{font-size:10px;font-weight:700;font-family:'DM Mono',monospace;color:var(--gold)}
...
.lp-card-source{font-size:8px;font-weight:800;padding:2px 6px;border-radius:20px;width:fit-content;letter-spacing:.06em;font-family:'DM Mono',monospace;text-transform:uppercase}
.lp-card-nm{font-size:13px;font-weight:800;color:var(--t1);line-height:1.3;font-family:'Bricolage Grotesque',sans-serif}
.lp-card-ref{font-size:9px;color:var(--t3);font-family:'DM Mono',monospace;line-height:1.4}
...
.lp-card-done-badge{font-size:9px;font-weight:700;color:var(--gold);font-family:'DM Mono',monospace}
...
(function () {
  ...
  const CSS = `
    ...
    .missions-score{ font-family:'DM Mono',monospace; font-size:10px; color:var(--gold); font-weight:700; }
    .mission-row{
    ...
    .mission-sub{ font-size:9px; color:var(--t3); margin-top:2px; font-family:'DM Mono',monospace; }
    ...
    .mission-xp{ font-family:'DM Mono',monospace; font-size:10px; color:var(--gold); font-weight:700; flex-shrink:0; }
    ...
    .phase-days-n{ font-family:'DM Mono',monospace; font-size:22px; font-weight:700; color:var(--gold); line-height:1; }
    ...
    .sp-row-sub{ font-size:9px; color:var(--t3); margin-top:2px; font-family:'DM Mono',monospace; }
    .sp-row-pct{ font-family:'DM Mono',monospace; font-size:11px; font-weight:700; flex-shrink:0; }
    ...
    .ses-kpi-v{ font-family:'DM Mono',monospace; font-size:22px; font-weight:700; line-height:1; }
    ...
    .perfect-badge{
      ...
      border-radius:100px; padding:5px 16px;
      font-family:'DM Mono',monospace; font-size:11px; font-weight:700; color:var(--gold);
    ...
    .err-insight-rate{ font-family:'DM Mono',monospace; font-size:11px; color:var(--err); font-weight:700; }
